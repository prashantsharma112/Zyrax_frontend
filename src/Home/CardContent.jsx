...
// const CardContent = ({ member, formatDescription }) => {
//   return (
//     <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 group-hover:translate-y-[-2rem] bg-opacity-90 bg-gray-800 rounded-xl shadow-lg transition-all duration-500 ease-in-out">
//       <div className="w-full max-w-[350px] bg-white p-6 rounded-xl shadow-lg relative">
//         {/* Circular Image */}
//         <div className="flex justify-center mb-4">
//           <img
