...
//     //     } else {
//     //         window.open(link, "_blank"); // Proceed to payment
//     //     }
//     // };
//     const handleBuyNow = (link) => {
//         if (!isAuthenticated) {
//             localStorage.setItem("redirectAfterLogin", link); // Save the link before login
//             openLoginModal(); // Open the login modal
//         } else
//             window.location.href = link; // Redirect if already authenticated
//         }
//     };
...
//                                         />
//                                         <button
//                                             onClick={() => handleBuyNow(item.text)}
//                                             className="ml-auto py-1 px-3 sm:px-5 rounded-md font-medium text-white transition-all duration-300 bg-purple-600 hover:bg-purple-800 hover:shadow-neon focus:ring focus:ring-purple-500"
//                                         >
//                                             Buy Now
//                                         </button>
