...
//         // Step 2: Fetch Subscription API request
//         if (user?.id) {
//           try {
...
//             console.log("fetch-subscription response:", subscriptionResponse.data);
//             setMessage(subscriptionResponse.data.message);
//           } catch (fetchError) {
...
//         window.location.reload();
//       } else {
//         setError(loginResponse.data.message || "Invalid phone number or password.");
//       }
//     } catch (err) {
//       console.error("Login error:", err);
//       setError("An error occurred. Please try again.");
...
//         >
//           <div className="flex items-center justify-between mb-4">
//             <h2 className="text-2xl sm:text-3xl text-left font-semibold text-white">
//               Sign In
//             </h2>
//           </div>
...
//             {error && <div className="text-red-500 text-xs mb-2">{error}</div>}
//             {message && <div className="text-green-500 text-xs mb-2">{message}</div>}
