...
const BeforeAfter = ({testimonials}) => {
  return (
    <div>
      <h2 className="text-center text-4xl font-bold mb-6">Transformation</h2>
        ...
        >
          {testimonials.map((item) => (
            <SwiperSlide key={item.title}>
              <div className="relative shadow-lg text-white rounded-xl overflow-hidden cursor-pointer">
                {/* Apply aspect ratio */}
