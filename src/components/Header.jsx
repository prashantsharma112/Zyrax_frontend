...
// import BottomNav from './subComponents/BottumNav'

// const Header = ({ openLoginModal, openRegisterModal, openBMICalculator }) => {
...
//             {/* Bottom Navigation - visible only on mobile view */}
                    ...
                    {!isAuthenticated ? (
                        ...
                        <div className="relative">
                            ...
                            {isDropdownOpen && (
                                <div className="absolute right-0 mt-15 bg-black shadow-lg rounded-lg z-20 opacity-90">
                                    <ProfileMenu
                                        openBMICalculator={() => { openBMICalculator(true); closeDropdown(); }}
                                        setIsAuthenticated={setIsAuthenticated}
