...
//   return (
//     <Section>
//     <div className="bg-[#16322f] text-white rounded-lg shadow-md max-w-md mx-auto mt-10 p-6 text-center">
//       {/* Title */}
...
//         <div className="bg-[#1f4e47] rounded-md px-4 py-2">
...
//   return (
//     <Section>
//       <div className="bg-[#16322f]  text-white rounded-lg shadow-md w-full max-w-3xl mx-auto  p-6 text-center">
//         {/* Title */}
//         <h1 className="text-3xl font-bold mb-2">{title}</h1>
//         {/* Offer Details */}
//         <p className="text-lg font-semibold mb-6">
