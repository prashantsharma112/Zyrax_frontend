...
//       <div className="grid grid-cols-7 gap-0.5 border-t">
//         {/* Day Labels */}
//         {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((day, index) => (
//           <div key={index} className="font-semibold text-xs py-1 text-center text-black border-b">
//             {day}
//           </div>
//         ))}
...
//             <div
//               key={i}
//               className={`py-3 text-center ${bgColor} ${day === currentDay ? 'font-bold' : ''} border-b`}
//             >
//               <p className="text-sm text-black">{day}</p>
//             </div>
//           );
//         })}
//       </div>
